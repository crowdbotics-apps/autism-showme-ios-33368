...
## Project Structure
    ...
    ├── autism_showme_ios_33368  # Django project configurations
...
1. Clone this repo and `cd autism_showme_ios_33368`
...
2. Clone this repo and `cd autism_showme_ios_33368`
